...
import com.bohui.common.constant.ProductConstant;
import com.bohui.common.to.SkuHasStockVo;
import com.bohui.common.to.SkuReductionTo;
import com.bohui.common.to.SpuBoundTo;
...
//    @GlobalTransactional
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        List<ProductAttrValueEntity> collect = baseAttrs.stream().map(attr -> {
            ...
            AttrEntity attrmodel = attrService.getById(attr.getAttrId());
            valueEntity.setAttrName(attrmodel.getAttrName());
